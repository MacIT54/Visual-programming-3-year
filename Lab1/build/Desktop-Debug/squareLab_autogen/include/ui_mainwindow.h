...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(530, 270);
        MainWindow->setMinimumSize(QSize(530, 270));
        MainWindow->setMaximumSize(QSize(530, 270));
        ...
        listFigure->setGeometry(QRect(10, 10, 161, 26));
        photoFigure = new QLabel(centralwidget);
        photoFigure->setObjectName("photoFigure");
        photoFigure->setGeometry(QRect(310, 20, 200, 200));
        ...
        pushButtonArea->setGeometry(QRect(100, 180, 111, 41));
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(10, 60, 281, 98));
